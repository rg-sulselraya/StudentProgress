...
const server = http.createServer(async (req, res) => {
  try {
    ...
    if (req.method === 'POST' && req.url === '/api/submissions') {
      ...
      rows.push(...submissions); saveSubmissions(rows); return json(res, 201, { success: true, ok: true, submission: submissions[0], submissions, student, duplicateWarning: duplicate });
    }
